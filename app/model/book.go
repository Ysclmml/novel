...
type Book struct {
	...
	AuthorID            int64          `gorm:"column:author_id;type:bigint(20)" json:"author_id,string"`                                                       // 作者id
	...
	LastIndexID         int64          `gorm:"column:last_index_id;type:bigint(20)" json:"last_index_id,string"`                                               // 最新目录ID
