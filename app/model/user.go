...
type UserBuyRecord struct {
	...
	CreateTime    time.JsonTime `gorm:"column:create_time;type:datetime" json:"create_time"`                                       // 购买时间
}
...
type UserFeedback struct {
	...
	CreateTime time.JsonTime `gorm:"column:create_time;type:datetime" json:"create_time"`     // 反馈时间
}
